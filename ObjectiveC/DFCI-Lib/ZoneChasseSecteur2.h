...
@interface ZoneChasseSecteur2 : CarreDFCI
@property(nonatomic)            int             numeroZone;

@property(nonatomic,strong)     Coord       *   coordSO;
@property(nonatomic,strong)     Coord       *   coordSOIntermediaire1;
@property(nonatomic,strong)     Coord       *   coordSOIntermediaire2;
@property(nonatomic,strong)     Coord       *   coordSOIntermediaire3;
