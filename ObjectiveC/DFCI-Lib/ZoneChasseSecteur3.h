...
@interface ZoneChasseSecteur3 : CarreDFCI
@property(nonatomic)            int             numeroZone;

@property(nonatomic,strong)     Coord       *   coordSO;
@property(nonatomic,strong)     Coord       *   coordNOIntermediaire1;
@property(nonatomic,strong)     Coord       *   coordNOIntermediaire2;
@property(nonatomic,strong)     Coord       *   coordNOIntermediaire3;
