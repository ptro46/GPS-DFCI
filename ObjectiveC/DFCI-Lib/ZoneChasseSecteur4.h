...
@interface ZoneChasseSecteur4 : CarreDFCI
@property(nonatomic)            int             numeroZone;

@property(nonatomic,strong)     Coord       *   coordSO;
@property(nonatomic,strong)     Coord       *   coordNO;
@property(nonatomic,strong)     Coord       *   coordNEIntermediaire1;
@property(nonatomic,strong)     Coord       *   coordNEIntermediaire2;
@property(nonatomic,strong)     Coord       *   coordNEIntermediaire3;
